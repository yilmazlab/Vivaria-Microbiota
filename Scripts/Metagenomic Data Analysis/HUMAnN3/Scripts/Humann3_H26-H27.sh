...
humann --input /storage/research/dbmr_yilmaz_gut_evo/Wild_Mice_Analysis/Metagenomics/Concatenate/Bahti_H${SLURM_ARRAY_TASK_ID}.fastq.gz --output /storage/research/dbmr_yilmaz_gut_evo/Wild_Mice_Analysis/Metagenomics/Humann3/Bahti_H${SLURM_ARRAY_TASK_ID}v2 --nucleotide-database /storage/homefs/terziev/humann3_chocophlan_database/chocophlan --bowtie2 /storage/homefs/terziev/bowtie2db/bowtie2-build --threads 20
