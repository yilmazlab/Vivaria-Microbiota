...
Taxa <- read.table("data/data_for_heatmap_pN_pS.csv", header = TRUE, sep = ",")
...
# Save the plot
ggsave("Heatmaps/Bacteroides acidifaciens heatmap for pN over pS.pdf", plot = p, width = 30, height = 25, useDingbats = FALSE, limitsize = FALSE)
...
# Save the plot
ggsave("Heatmaps/Bacteroides acidifaciens heatmap for pN over pS without hypothetical proteins.pdf", plot = p, width = 40, height = 80, useDingbats = FALSE, limitsize = FALSE)
...
# Save the plot
ggsave("Heatmaps/Bacteroides acidifaciens heatmap for pN over pS without hypothetical proteins only positively selected.pdf", plot = p, width = 40, height = 25, useDingbats = FALSE, limitsize = FALSE)
...
# Save the plot
ggsave("Heatmaps/Bacteroides acidifaciens heatmap for pN over pS only positively selected.pdf", plot = p, width = 40, height = 40, useDingbats = FALSE, limitsize = FALSE)
